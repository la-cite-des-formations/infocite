<div class="col">
    <div class="form-row">
        <div class="form-group col mt-3">
            <label title="Sélectionner les groupes à retirer"
                   for="app-linked-groups">Groupes utilisateurs</label>
        ...
        <div class="d-flex form-group col-1 my-auto">
            <div class="btn-group-vertical btn-group-sm mx-auto" role="group">
                <button wire:click="add" class="d-flex btn btn-sm btn-success p-0" type="button"
                        title ="Ajouter les groupes disponibles sélectionnés aux groupes utilisateurs">
                ...
                <button wire:click="remove" class="d-flex btn btn-sm btn-danger p-0" type="button"
                        title ="Retirer les groupes utilisateurs sélectionnés">
