    ...
    <div class="form-row">
        <div class="form-group col mt-3">
            <label title="Sélectionner les utilisateurs à dissocier"
                   for="profile-linked-users">Utilisateurs associés</label>
            <select id="profile-linked-users" multiple wire:model="selectedLinkedUsers" class="form-control" size="10">
        ...
        <div class="form-group col mt-3">
            <label title="Sélectionner les utilisateurs à ajouter"
                   for="profile-available-users">Utilisateurs disponibles</label>
