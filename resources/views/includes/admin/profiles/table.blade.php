...
@section('table-head')
    <tr class="row">
        <th scope="col" class="col @cannot('deleteAny', ['App\\Models\\User', TRUE]) p-2 @endcannot">
            <div class="d-flex align-items-center">
              @can('deleteAny', ['App\\Models\\User', TRUE])
        ...
        <th scope="col" class="col-3 d-flex justify-content-end">
            <div class="btn-toolbar" role="toolbar">
               @can('create', ['App\\Models\\User', TRUE])
...
@isset($profiles)
 @section('table-body')
  @foreach ($profiles as $profile)
   @if(auth()->user()->canany(['view', 'update', 'delete'], [$profile, TRUE]) || auth()->user()->can('adminRights', ['App\\Models\\User', TRUE]))
    <tr class="row">
        ...
        <td class="col-3 d-flex justify-content-end align-items-center">
          @if(auth()->user()->can('view', [$profile, TRUE]) || auth()->user()->can('adminRights', ['App\\Models\\User', TRUE]))
