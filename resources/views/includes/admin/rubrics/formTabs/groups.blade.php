    ...
    <div class="row g-0">
        <div class="col mt-1 pt-1">
            <label title="Sélectionner les groupes à dissocier"
                   for="rubric-groups" class="form-label m-auto py-2">Groupes associés</label>
            <div class="input-group mb-1">
                <div class="input-group-text text-secondary" title="Type de groupe">
                    <span class="material-icons md-18">category</span>
                </div>
                <select wire:model="groupType" class="form-select" id="rubric-group-type">
        ...
        <div class="col mt-1 pt-1">
            <label title="Sélectionner les groupes à associer"
                   for="rubric-available-groups" class="form-label m-auto py-2">Groupes disponibles</label>
            <div class="input-group mb-1">
