<div class='container'>
    <div class='container'>
        <div class='row'>
            <div class='col'>
                <h5 class='fw-bold'>Top 10 des utilisateurs d'applications personnelles</h5>
    ...
    <div class='row'>
        <div wire:ignore id='personalAppsUsersTop10Chart' class='col' style="height:500px;"></div>
        ...
        <tbody>
          @foreach ($personalAppsUsers as $user)
            <tr class='row'>
                ...
                <td class='col'>{{ $user->comments_nb }}</td>
            </tr>
          @endforeach
        </tbody>
    </table>
